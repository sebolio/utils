...
```bat
choco install -y --allow -empty-checksums --ignore-checksum googlechrome notion authy-desktop winrar vscode spotify slack epicgameslauncher steam goggalaxy auto-dark-mode
```
